...
- [Terms of Reference for Project Location Data Collection and Management as part of Project Reporting](https://github.com/openkfw/open-geodata-model/blob/main/docs/sample_tor.md)
...
- [Terms de Reference pour la collecte et la gestion des données de sites du projet dans le cadre du rapportage du projet](https://github.com/openkfw/open-geodata-model/blob/main/docs/sample_tor_fr.md/)
...
Please have a look at the [Technical Notes](../docs/technical_notes/) on how to fill out the Excel Template (in English). You will find the same technical notes also in the table "READ-ME" in the Excel Template in the respective languages.
