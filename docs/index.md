...
| **Type of location data** | **Example**           | **How to collect**      |  **Comment**  |
| --------------------------|:-----------------------:| -----------------------:| -------------:|
| Administrational Boundaries  |     | Excel (LAT/LONG) + KML|If GADM boundaries are available, you may state its GADM GID (e.g. VNM.1.1.1_1 in Vietnam) the GID level (e.g. level 4) and GADM Version (e.g. 4.0.4) = VNM.1.1.1_L4_1_4.0.4 as "Project-specific location identifier" in Column G. Supplement this information in Excel by giving e.g., the centroid of the polygon in Columns T and U. |  
| Municipality/district Center  |                   |Excel (LAT/LONG)  |If no GADM boundaries are available, you can also upload the boundaries of the administrational area as a Polygon in KML. Supplement this information with Excel where you can. Give e.g., the centroid of the polygon|
