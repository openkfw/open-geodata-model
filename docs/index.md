...
### Geometrical characteristics of exact locations
...
Independent of the geometry type all project locations should be collected first as a point. This point may represent the locaction itself or a gateway to the project site, irrespective of the actual feature geometry (i.e., also for lines and polygons). The gateway point may be e.g. the beginning of a road, a village adjacent to agricultural plots or the administration building of a protected area. The coordinates from this point have to be submitted in the Excel form. If there is a line or polygon geometry and no gateway/entry point can be defined, the geometrical center (centroid) may be used as well. 
...
## Project Location Model Formats and Templates
